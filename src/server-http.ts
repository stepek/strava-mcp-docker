...
// Function to register all tools on a server
...
// Configure CORS for browser-based clients (like Poke)
app.use(
    cors({
...
// Create the MCP server once (stateless mode - recommended for Poke)
